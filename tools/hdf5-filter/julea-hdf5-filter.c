...
static htri_t
compressorCanCompress(hid_t dcpl_id, hid_t type_id, hid_t space_id)
{
	return PLUGIN_OK;
}

static herr_t
compressorSetLocal(hid_t pList, hid_t type_id, hid_t space)
{
	return PLUGIN_OK;
}

static size_t
compressorFilter(unsigned int flags, size_t cd_nelmts,
